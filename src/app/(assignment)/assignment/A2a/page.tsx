...
export default function TestPage() {
  ...
  useEffect(() => {
    ...
    //RAHHHH
    const fixedPath = '/bonsai_256x256x256_uint8.raw'; // Replace with the actual path
    // const fixedPath = '/stag_beetle_832x832x494_uint16.raw'; // Replace with the actual path
